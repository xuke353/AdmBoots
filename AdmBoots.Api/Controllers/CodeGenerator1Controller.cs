...
namespace AdmBoots.Api.Controllers {
    ...
    [AllowAnonymous]
    public class CodeGenerator1Controller : ControllerBase {
        private readonly IWebHostEnvironment _env;

        public CodeGenerator1Controller(IWebHostEnvironment env) {
            _env = env;
        }
        ...
        /// <returns></returns>
        [HttpGet]
        public IActionResult GetFrameFiles([FromQuery]CodeGenerator1Input input) {
...
namespace {nameSpace}" + @"
{
    ...
    public class CodeGenerator1Input {
